...
export default function BoxUpdate() {
  ...
  useEffect(() => {
    document.title = 'Изменить коробку';
    setCSRFToken();
    refreshObjectDetail(setFormData, `/api/storage/box/${id}`)
    }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    handleUpdate(e, formStorage, `/api/storage/box/${id}/update/`, `/storage/box/${id}/`, setError, navigate)
  };
